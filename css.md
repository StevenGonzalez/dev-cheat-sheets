...
.layer-2 {
  z-index: 2;
} /* Appears above layer-1 */
.layer-3 {
  z-index: -1;
} /* Appears below default layer (0) */
...
:lang(en) {
  font-family: "English Font", serif;
}
:lang(fr) {
...
.button--primary {
  background: blue;
} /* New class with higher specificity */
```
...
- **MDN CSS Reference**: https://developer.mozilla.org/en-US/docs/Web/CSS - Comprehensive documentation
- **Can I Use**: https://caniuse.com/ - Browser compatibility tables
- **CSS Specifications**: https://www.w3.org/Style/CSS/ - Official W3C standards
